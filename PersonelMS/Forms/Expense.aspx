<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expense.aspx.cs" Inherits="PersonelMS.Forms.Expense" %>
                    ...
                    <td>
                        ...
                        <ItemTemplate>
                            ...
                            <tr>
                                ...
                                <td>
                                    <telerik:RadTextBox ID="txtPayTo" runat="server" Enabled="False" Width="100%">
                                    </telerik:RadTextBox>
                                </td>
                                <td>
...
<GroupingSettings CaseSensitive="False" CollapseAllTooltip="Collapse all groups"></GroupingSettings>
                ...
                <MasterTableView>
                    <Columns>
                        ...
                        <telerik:GridBoundColumn DataField="PayTo" FilterControlAltText="Filter PayTo column" HeaderText="Pay To" SortExpression="PayTo" UniqueName="PayTo">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text="" />
                            </ColumnValidationSettings>
                        </telerik:GridBoundColumn>
                        ...
                        <telerik:GridBoundColumn DataField="Remarks" FilterControlAltText="Filter Remarks column" HeaderText="Remarks/Details" SortExpression="Remarks" UniqueName="Remarks">
                            <ColumnValidationSettings>
                                <ModelErrorMessage Text="" />
                            </ColumnValidationSettings>
