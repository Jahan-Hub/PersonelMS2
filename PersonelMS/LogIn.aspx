<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LogIn.aspx.cs" Inherits="PersonelMS.LogIn" %>
...
<body style="background-image: none; background-size: unset; background-repeat: no-repeat; background-position: center; background-color: lightgray;">
    <form id="form1" runat="server">
        ...
        <div style="width: 410px; margin-left: 40%; margin-right: 40%; margin-top: 20%; background-color: green; color: blue; border-radius: 5px 6px; text-align: center">
            <h1>
                <asp:Label ID="lblHeading" runat="server" Text="Jahan's World"></asp:Label>
            </h1>
        </div>
