...
namespace PersonelMS
{
    ...
    public partial class PersonelMSEntities : DbContext
    {
        public PersonelMSEntities()
            : base("name=PersonelMSEntities")
        {
        }
        ...
        public virtual DbSet<tblRatioCalculationDTL> tblRatioCalculationDTLs { get; set; }
        public virtual DbSet<tblRatioCalculationHDR> tblRatioCalculationHDRs { get; set; }
